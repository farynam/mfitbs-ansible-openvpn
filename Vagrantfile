...
Vagrant.configure("2") do |config|
  ...
  config.vm.provision "aptupdate" , type: "shell", inline: "apt-get update"
  config.vm.provision "sshpass" , type: "shell", inline: "apt-get -y install sshpass"
  config.vm.provision "python" , type: "shell", inline: "apt-get install -y python3 python3-setuptools python3-dev build-essential python3-pip python3-setuptools"
